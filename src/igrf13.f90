!*==igrf13.f90 processed by SPAG 8.01MH 15:55 30 Jan 2024
...
99012          FORMAT (1X,F6.1,F8.2,I6,F7.2,I4,I7,I6,3(I8,I6),I7,I6)
            ENDDO
            ifl = 2
         ELSE
!
...
!*==igrf13syn.f90 processed by SPAG 8.01MH 15:55 30 Jan 2024
!!SPAG Open source Personal, Educational or Academic User  NON-COMMERCIAL USE - Not for use on proprietary or closed source code
...
!*** Start of declarations inserted by SPAG
   ...
   DOUBLE PRECISION gs , one , p , q , r , ratio , rho , rr , sd , sl , st , t , tc , three , two , X , Y , Z
   INTEGER i , Isv , Itype , j , k , kmx , l , ll , lm , m , n , nc , nmx
!*** End of declarations inserted by SPAG
   DIMENSION gh(3645) , g0(120) , g1(120) , g2(120) , g3(120) , g4(120) , g5(120) , g6(120) , g7(120) , g8(120) , g9(120) , ga(120)&
           & , gb(120) , gc(120) , gd(120) , ge(120) , gf(120) , gg(120) , gi(120) , gj(120) , gk(195) , gl(195) , gm(195) ,       &
           & gp(195) , gq(195) , gr(195) , gs(195) , p(105) , q(105) , cl(13) , sl(13)
   EQUIVALENCE (g0,gh(1)) , (g1,gh(121)) , (g2,gh(241)) , (g3,gh(361)) , (g4,gh(481)) , (g5,gh(601)) , (g6,gh(721)) , (g7,gh(841)) &
    ...
    & , (gq,gh(3061)) , (gr,gh(3256)) , (gs,gh(3451))
!
   ...
   DATA gp/ - 29496.57 , -1586.42 , 4944.26 , -2396.06 , 3026.34 , -2708.54 , 1668.17 , -575.73 , 1339.85 , -2326.54 , -160.40 ,   &
      ...
      & -0.26 , -0.79/
   DATA gq/ - 29441.46 , -1501.77 , 4795.99 , -2445.88 , 3012.20 , -2845.41 , 1676.35 , -642.17 , 1350.33 , -2352.26 , -115.29 ,   &
      & 1225.85 , 245.04 , 581.69 , -538.70 , 907.42 , 813.68 , 283.54 , 120.49 , -188.43 , -334.85 , 180.95 , 70.38 , -329.23 ,   &
      & -232.91 , 360.14 , 46.98 , 192.35 , 196.98 , -140.94 , -119.14 , -157.40 , 15.98 , 4.30 , 100.12 , 69.55 , 67.57 , -20.61 ,&
      & 72.79 , 33.30 , -129.85 , 58.74 , -28.93 , -66.64 , 13.14 , 7.35 , -70.85 , 62.41 , 81.29 , -75.99 , -54.27 , -6.79 ,      &
      & -19.53 , 51.82 , 5.59 , 15.07 , 24.45 , 9.32 , 3.27 , -2.88 , -27.50 , 6.61 , -2.32 , 23.98 , 8.89 , 10.04 , -16.78 ,      &
      & -18.26 , -3.16 , 13.18 , -20.56 , -14.60 , 13.33 , 16.16 , 11.76 , 5.69 , -15.98 , -9.10 , -2.02 , 2.26 , 5.33 , 8.83 ,    &
      & -9.3 , -1.4 , -11.9 , 9.6 , -1.9 , -6.2 , 3.4 , -0.1 , -0.2 , 1.7 , 3.6 , -0.9 , 4.8 , 0.7 , -8.6 , -0.9 , -0.1 , 1.9 ,    &
      & -4.3 , 1.4 , -3.4 , -2.4 , -0.1 , -3.8 , -8.8 , 3.0 , -1.4 , 0.0 , -2.5 , 2.5 , 2.3 , -0.6 , -0.9 , -0.4 , 0.3 , 0.6 ,     &
      & -0.7 , -0.2 , -0.1 , -1.7 , 1.4 , -1.6 , -0.6 , -3.0 , 0.2 , -2.0 , 3.1 , -2.6 , -2.0 , -0.1 , -1.2 , 0.5 , 0.5 , 1.3 ,    &
      & 1.4 , -1.2 , -1.8 , 0.7 , 0.1 , 0.3 , 0.8 , 0.5 , -0.2 , -0.3 , 0.6 , -0.5 , 0.2 , 0.1 , -0.9 , -1.1 , 0.0 , -0.3 , 0.5 ,  &
      & 0.1 , -0.9 , -0.9 , 0.5 , 0.6 , 0.7 , 1.4 , -0.3 , -0.4 , 0.8 , -1.3 , 0.0 , -0.1 , 0.8 , 0.3 , 0.0 , -0.1 , 0.4 , 0.5 ,   &
      & 0.1 , 0.5 , 0.5 , -0.4 , -0.5 , -0.4 , -0.4 , -0.6/
   DATA gs/5.7 , 7.4 , -25.9 , -11.0 , -7.0 , -30.2 , -2.1 , -22.4 , 2.2 , -5.9 , 6.0 , 3.1 , -1.1 , -12.0 , 0.5 , -1.2 , -1.6 ,   &
      & -0.1 , -5.9 , 6.5 , 5.2 , 3.6 , -5.1 , -5.0 , -0.3 , 0.5 , 0.0 , -0.6 , 2.5 , 0.2 , -0.6 , 1.3 , 3.0 , 0.9 , 0.3 , -0.5 ,  &
      & -0.3 , 0.0 , 0.4 , -1.6 , 1.3 , -1.3 , -1.4 , 0.8 , 0.0 , 0.0 , 0.9 , 1.0 , -0.1 , -0.2 , 0.6 , 0.0 , 0.6 , 0.7 , -0.8 ,   &
      & 0.1 , -0.2 , -0.5 , -1.1 , -0.8 , 0.1 , 0.8 , 0.3 , 0.0 , 0.1 , -0.2 , -0.1 , 0.6 , 0.4 , -0.2 , -0.1 , 0.5 , 0.4 , -0.3 , &
      & 0.3 , -0.4 , -0.1 , 0.5 , 0.4 , 0.0 , 115*0.0/
!
!     set initial values
!
   X = 0.0
   Y = 0.0
   Z = 0.0
   IF ( Date<1900.0 .OR. Date>2030.0 ) THEN
!
...
99001 FORMAT (/' This subroutine will not work with a date of',f9.3,'.  Date must be in the range 1900.0.ge.date',                 &
             &'.le.2030.0. On return f = 1.0d8., x = y = z = 0.')
      RETURN
   ELSE
      IF ( Date>2025.0 ) WRITE (6,99002) Date
99002 FORMAT (/' This version of the IGRF is intended for use up',' to 2025.0.'/' values for',f9.3,' will be computed',            &
